...
const JwtRegisterPublic = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        setSuccessful(false);
        try {
            await register(state.name, state.nip, state.nik, state.username, state.email, state.password)
            .then(() => {
    ...
    const { name, nik, username, email, agreement } = state
        ...
        >
            <Card className={classes.card}>
                ...
                <Grid container>
                    ...
                    <h3 className="text-center">Daftar Akun Masyarakat</h3>
...
export default JwtRegisterPublic
